...
public class TeacherLeave extends JFrame implements ActionListener {
    ...
    private void printLeaveApplication() {
        ...
        String html = "<html><body style='font-family:Arial; padding:10px;'>"
                ...
                + "<p><b>1. Name:</b> " + name + "</p>"
                + "<p><b>2. Teacher ID:</b> " + tid + "</p>"
                + "<p><b>3. Designation:</b> " + designation + "</p>"
                + "<p><b>4. NID:</b> " + nid + "</p>"
                + "<p><b>5. Leave Type:</b> " + type + "</p>"
                + "<p><b>6. Leave Start Date:</b> " + startDate + "</p>"
                + "<p><b>7. Leave End Date:</b> " + endDate + "</p>"
                + "<p><b>8. Total Leave Days:</b> " + totalDays + "</p>"
                + "<p><b>9. Reason:</b> " + reason + "</p>"
                + "<p><b>10. Workplace Leave Permission:</b> " + permission + (permission.equals("Yes") ? " — " + permissionReason : "") + "</p>"
                + "<p><b>11. Phone:</b> " + phone + "</p>"
                + "<p><b>12. Email:</b> " + email + "</p>"
                + ("Casual".equalsIgnoreCase(type) ? ("<p><b>13. Previously Enjoyed (Casual, this year):</b> " + prev + "</p>"
                + "<p><b>14. Remaining (Casual, this year):</b> " + remain + "</p>") : "")
